...
class RankingRedeSubView extends StatefulWidget {

  int idRede;
  String nomeRede;
  int ano;
  int tipo;
  RankingRedeSubView(this.idRede, this.nomeRede, this.ano, this.tipo);

  @override
  _RankingRedeSubViewState createState() => _RankingRedeSubViewState();
}

class _RankingRedeSubViewState extends State<RankingRedeSubView> {
